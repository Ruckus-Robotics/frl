...
TEST_F(RigidBodyTransformTest, testSetRotationAndZeroTranslationWithAxisAngle)
{
	...
	for (int i = 0; i < nTests; i++)
	{
		...
		for (int i = 0; i < 1; i++)
		{
			...
			std::cout << axisAngle.axis()[0]  << "," << axisAngle.axis()[1] << "," << axisAngle.axis()[2] << std::endl;
			std::cout << axisAngleToCheck.axis()[0] << "," << axisAngleToCheck.axis()[1] << "," << axisAngleToCheck.axis()[2] << std::endl;
